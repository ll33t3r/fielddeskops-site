...
import { LogOut, Settings, Bell, Menu, X, Home, BarChart, Package, Camera, FileSignature, Check, Clock, User, DollarSign, TrendingUp, AlertCircle, CheckCircle, CreditCard, Shield, Zap, Users, Wrench } from 'lucide-react';
import { createClient } from '../../lib/supabase/client';
import { getCurrentUser, getUserProfile, signOutUser } from '../../lib/supabase/utils';
...
export default function Dashboard() {
  ...
  const handleAppClick = (app, e) => {
    ...
    // Navigate to app (these are placeholder URLs for now)
    e.preventDefault();
    alert(`Opening ${app.name}... (App coming soon!)`);
    // router.push(app.url);
  };

  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#FF6700] to-orange-500 mx-auto mb-4 flex items-center justify-center animate-pulse">
